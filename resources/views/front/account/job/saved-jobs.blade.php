              ...
              <table class="table ">
                ...
                <tbody class="border-0">
                  ...
                  <tr class="active">
                    ...
                    <td>{{round($savedjob->job->applications->count()) }} Applications</td>
                    <td>
                    ...
                    <td>
                      ...
                      <div class="action-dots float-end">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li><a class="dropdown-item" href="{{route('jobdetail',$savedjob->id)}}"> <i class="fa fa-eye"
                                aria-hidden="true"></i> View</a></li>
                                
                          <li><a class="dropdown-item" href="#" onclick="removeJob({{ $savedjob->id }})" > <i class="fa fa-trash" aria-hidden="true"></i>
                              Remove</a></li>
                        </ul>
                      </div>
                    </td>
