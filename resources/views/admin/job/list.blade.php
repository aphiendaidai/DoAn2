                  ...
                  @if($jobs->isNotEmpty())
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="job-status text-capitalize">
                            <span class="text-success">Active </span> </div>
                          @else
                          <div class="job-status text-capitalize">
                            <span class="text-danger">Block</span> </div>
                          @endif
                        </td>
                   ...
                   <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              ...
                              <li><a class="dropdown-item" href="javascript:void(0);" onclick="deleteAdminJob({{ $job->id }})">Delete</a></li>
                            </ul> 
                          </div>
                        </td>
                      </tr>
...
<script>
  ...
  function deleteAdminJob(id) {
    if (confirm("Are you sure you want to delete?")) {
      $.ajax({
        url: '{{ route("admin.deleteAdminJob") }}',
        type: "POST",
        data: { id: id },
        dataType: 'json',
