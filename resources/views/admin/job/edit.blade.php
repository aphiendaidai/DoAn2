            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body card-form">
                        <form action="" method="post" id="editAdminJobForm" name="editAdminJobForm">
                            <div class="card border-0 shadow mb-4 ">
                                <div class="card-body card-form p-4">
                                            ...
                                            <select class="form-select" name="jobType" id="jobType">
                                                @if($jobTypes->isNotEmpty())
                                                    @foreach($jobTypes as $jobType)
                                                        <option {{ ($job->jobType_id == $jobType->id) ? 'selected' : '' }}
                                    ...
                                    <div class="row">
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <input value="{{$job->salary}}" type="text" placeholder="Salary" id="salary"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <input value="{{$job->company_location}}" type="text" placeholder="Location"
...
<script>
    ...
    $("#editAdminJobForm").submit(function (e) {
        ...
        $.ajax({
            ...
            type: 'PUT',
            dataType: 'json',
            data: $("#editAdminJobForm").serializeArray(),
